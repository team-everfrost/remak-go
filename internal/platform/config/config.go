...
func Load() (Config, error) {
	cfg := Config{
		...
		ScrapeRequestQueueURL: value(
			"SCRAPE_REQUEST_QUEUE_URL",
			"http://localhost:4566/000000000000/remak-scrape-request",
		),
		ScrapeResultQueueURL: value(
			"SCRAPE_RESULT_QUEUE_URL",
			"http://localhost:4566/000000000000/remak-scrape-result",
		),
